...
<head>
    ...
    <title><?php echo htmlspecialchars($product['Title']); ?> | Second Hand Sensations</title>
    ...
    <style>
        ...
        .product-images {
            flex: 1; /* Thumbnail grid takes up half the space */
            display: grid;
            grid-template-columns: repeat(4, minmax(50px, 1fr)); /* Always display 4 image containers */
            grid-gap: 10px;
            margin: 10px;
        }
